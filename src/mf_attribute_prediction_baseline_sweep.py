...
from data_loader import DatabaseAttribute
from matrix_factorisation import MFEngine
from utils import instance_bpr_loader_attr, predict_full_attr, save_json

model_name = "MF"
project_name = "pathway_attribute_predict_MF_sweep_2024_May"
...
class MF_train:
    ...
    def train(self):
        ...
        global valid_result
        train_loader = instance_bpr_loader_attr(
            data=self.train_set,
            batch_size=self.config["batch_size"],
            device=self.config["device_str"],
            n_attribute=self.n_attributes,
        ...
        for epoch in epoch_bar:
            ...
            predictions = predict_full_attr(validation_set, self.engine)
    ...
    def test(self, model=None):
        ...
        predictions = predict_full_attr(test_set, model)
...
def sweep():
    ...
    for task in ["attribute prediction dataset"]:
        for dataset in [
            ...
            sweep_id = wandb.sweep(sweep_config, project=f"MF_attribute_sweep_2023_May")
