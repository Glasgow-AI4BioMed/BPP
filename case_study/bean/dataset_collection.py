...
class Dataset:
    ...
    def add_attribute(self, attribute: Attribute) -> bool:
        if (attribute.index not in self.attributes_dict.keys()) or (attribute not in self.attributes_list):
    ...
    def add_node(self, node: Node) -> bool:
        if (node.index not in self.nodes_dict.keys()) or (node not in self.nodes_list):
    ...
    def add_edge(self, edge: Edge) -> bool:
        if (edge.index not in self.edges_dict.keys()) or (edge not in self.edges_list):
